...
class MySQLInterface:
  ...
  # insert a house and recursively insert associated rooms/devices.
  def insert_house(self, house):
    ...
    print "Inserting House   : %s" % query
    self._cur.execute(query)

  # insert a room and recursively insert associated devices.
  ...
  def insert_device(self, device):
    ...
    print "Inserting Device  : %s" % query
    self._cur.execute(query)
